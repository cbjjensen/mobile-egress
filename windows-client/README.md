...
- EC2 service: `MobileEgressClient`, LocalSystem, auto start, authenticated SOCKS5 at `127.0.0.1:1080` and authenticated HTTP CONNECT at `127.0.0.1:1081`, state `C:\ProgramData\MobileEgress\Client`.
