...
object AgentCapacity {
    ...
    const val OUTBOUND_DATA_BYTE_CAPACITY = 64 * 1024 * 1024
    const val REACTOR_DATA_COMMAND_CAPACITY = 8_192
    const val REACTOR_CONTROL_RESERVE_CAPACITY = 1_024
    const val REACTOR_COMMAND_CAPACITY = REACTOR_DATA_COMMAND_CAPACITY + REACTOR_CONTROL_RESERVE_CAPACITY
    const val REACTOR_COMMANDS_PER_CYCLE = 512
    const val TARGET_INBOUND_PER_STREAM_CAPACITY = 32
    const val TARGET_INBOUND_SESSION_FRAME_CAPACITY = 8_192
    const val TARGET_INBOUND_SESSION_BYTE_CAPACITY = 64 * 1024 * 1024
