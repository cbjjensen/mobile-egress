...
object AgentCapacity {
    ...
    const val TARGET_INBOUND_PER_STREAM_CAPACITY = 8
    const val TARGET_INBOUND_SESSION_FRAME_CAPACITY = 512
    const val TARGET_INBOUND_SESSION_BYTE_CAPACITY = 8 * 1024 * 1024
